" Setting up Vundle - the vim plugin bundler
    ...
    " General {
        ...
        Plugin 'rhysd/conflict-marker.vim' " Weapon to fight against conflicts in Vim
    ...
    " Misc {
        ...
        Plugin 'evanmiller/nginx-vim-syntax' " nginx vim syntax
    ...
    " Snippets & AutoComplete {
        Plugin 'Shougo/neocomplete.vim.git' " Next generation completion framework after neocomplcache
